    ...
    def actions(self):
        ...
        async def help(ctx, option=None):
            if option is None:
                ...
                rsmod_embed.add_field(name=f"RS Mods", value=f"There are currently 14 different mods you can tell players about when you join a queue. They are: ```croid, influence, nosanc, rse, veng, notele, barrage, suppress, unity, laser, battery, dart, solo, solo2``` If you'd like to get more information based on each mod, type `!rsmod`.", inline=False)
